        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$50,46,342</p>
            </div>
          </div>
            <div className="mt-6">
          ...
          <div className="flex justify-between">
            ...
            <div className="mt-10 flex gap-10 flex-wrap justify-center">
              <div className="border-r-1 border-color m-4 pr-10">
                <div>
                  <p>
                    <span className="text-3xl font-semibold">$2107863</span>
                    <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 m-3 text-xs">49%</span>
                  </p>
                  <p className="text-gray-500 mt-1">Budget</p>
                </div>
                <div className="mt-8">
                  <p>
                    <span className="text-3xl font-semibold">$1546732</span>
                  </p>
